...
w_com = None             # weight of center of mass task
...
kp_com = None           # proportional gain of center of mass task
...
print(" 0: w_com=1.0, kp_com=10.0 (default)")
print(" 1: w_com=10.0, kp_com=10.0")
print(" 2: w_com=1.0, kp_com=100.0")
input_data = input()
if input_data == "0":
    w_com = 1.0
    kp_com = 10.0
