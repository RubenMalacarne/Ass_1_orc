...
for i in range(0, N):
    ...
    # upgrade at each time step of the CoM (valore, derivata I e II)
    ...
    # task that robot should to follow
    tsid.comTask.setReference(sampleCom)    #task con il movimento oscillatorio
    tsid.postureTask.setReference(samplePosture)

    # calcolo della ottimizzazione quadratica QP
